	...
	private void handleKill(L2PcInstance activeChar, String player)
	{
		...
		if (target != null)
		{
			...
			else
			{
				...
				// L2MonsterInstance HP Admin View Multiplier
				...
				// L2RaidBossInstance HP Admin View Multiplier
				...
				// Minion HP Admin View Multiplier
				if (target.isMinion())
				{
				...
				// L2GrandBossInstance HP Admin View Multiplier
				...
				// L2DefenderInstance HP Admin View Multiplier
