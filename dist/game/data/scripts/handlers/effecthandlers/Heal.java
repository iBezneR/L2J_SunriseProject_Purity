...
public class Heal extends L2Effect
{
	...
	public boolean onStart()
	{
		...
		if (!getSkill().isStatic())
		{
			...
			{
				amount *= 3;
				getEffector().sendPacket(SystemMessageId.CRITICAL_HIT_MAGIC);
				...
				if (getEffected().isPlayer() && (getEffected() != getEffector()))
				{
		...
		// {
		// activeChar.getActingPlayer().getAchievementPlayer().addAchievementPoints("heal", (int) amount);
		// }
