...
import custom.SellBuff.SellBuffsManager;
...
public class L2PcInstanceAction implements IActionHandler
{
	...
	public boolean action(L2PcInstance activeChar, L2Object target, boolean interact)
	{
		...
		else if (interact)
		{
			...
			{
				if (SellBuffsManager.getInstance().isSellingBuffs(player))
				{
					SellBuffsManager.getInstance().sendBuffMenu(activeChar, player, 0);
				}
				else
				{
