...
public final class L2EnchantSkillLearn
{
	...
	public int getMaxEnchantLevel(int level)
	{
		int enchantType = getEnchantRoute(level);
		if ((enchantType < 1) || !_enchantRoutes.containsKey(enchantType))
		{
		...
		return EnchantSkillGroupsData.getInstance().getEnchantSkillGroupById(_enchantRoutes.get(enchantType)).getEnchantGroupDetails().size();
	}
