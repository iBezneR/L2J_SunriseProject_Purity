...
public abstract class L2Skill implements IChanceSkillTrigger, IIdentifiable
{
	...
	private final boolean _leavesForSubclass;
	...
	protected L2Skill(StatsSet set)
	{
		...
		_leavesForSubclass = set.getBoolean("leavesForSubclass", false);
	}
	...
	{
		return _level > 100 ? ((_level + (1000 * (_level / 100))) - ((_level / 100) * 100)) : 0;
	}
    ...
    public boolean leavesForSubclass()
    {
        return _leavesForSubclass;
    }
