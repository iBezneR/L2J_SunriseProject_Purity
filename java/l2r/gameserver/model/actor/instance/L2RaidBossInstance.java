		...
		if (player != null)
		{
			...
			if (player.getParty() != null)
			{
				for (L2PcInstance member : player.getParty().getMembers())
				{
					...
					member.getAchievementPlayer().addAchievementPoints("raid_kills", 1);
					member.getAchievementPlayer().addAchievementPoints("raid_id_kills_" + getId(), 1);
			...
			else
			{
				...
				player.getAchievementPlayer().addAchievementPoints("raid_kills", 1);
				player.getAchievementPlayer().addAchievementPoints("raid_id_kills_" + getId(), 1);
