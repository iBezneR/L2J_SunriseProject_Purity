		...
		if (win)
		{
			...
			if (fishingMonster != null)
			{
				...
				else
				{
					...
					// Museum and Achievement Fishing
					_fisher.getAchievementPlayer().addAchievementPoints("fishing", 1);
					_fisher.getAchievementPlayer().addAchievementPoints("daily_fishing", 1);
					_fisher.getMuseumPlayer().addData("gone_fishing", 1);
