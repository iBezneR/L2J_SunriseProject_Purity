...
public enum AbnormalEffect
{
	...
	/**
	 * @param id the mask of the abnormal effect to get.
	...
	public static AbnormalEffect getById(int id)
	{
		...
		throw new NoSuchElementException(AbnormalEffect.class.getSimpleName() + ": Abnormal effect not found for id: " + id + "!");
	}
