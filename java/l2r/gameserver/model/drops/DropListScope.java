...
//	Alternative Scope used in 'Rolling' Groups
	DEATH((itemId, min, max, chance) -> new GeneralDropItem(itemId, min, max, chance, IAmountMultiplierStrategy.DROP, IChanceMultiplierStrategy.DROP), chance -> new GroupedGeneralDropItem(chance, IGroupedItemDropCalculationStrategy.PRECISE_MULTIPLE_GROUP_ROLLS, IKillerChanceModifierStrategy.NO_RULES, IPreciseDeterminationStrategy.DEFAULT)),
	CORPSE((itemId, min, max, chance) -> new GeneralDropItem(itemId, min, max, chance, IAmountMultiplierStrategy.SPOIL, IChanceMultiplierStrategy.SPOIL), DEATH),
