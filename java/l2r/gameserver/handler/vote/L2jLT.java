 ...
 * @author Erlandys
 */
public class L2jLT extends IVote
{
	public L2jLT(int id, String type, String link, String linkToCheck, int refreshesAfter, HashMap<Integer, ArrayList<ErReward>> allRewards, HashMap<Integer, ArrayList<ErBonus>> allBonuses, ArrayList<Integer> rewardIds, boolean withIP)
	{
