		...
		synchronized (item)
		{
			...
			switch (resultType)
			{
				...
				case SUCCESS:
				{
					...
					{
						if (scrollTemplate.isBlessed() && (activeChar.getAchievementPlayer().getAchievementCount("blessed_enchant") < item.getEnchantLevel()))
						{
							activeChar.getAchievementPlayer().setAchievementPoints("blessed_enchant", item.getEnchantLevel());
						}
						else if (!scrollTemplate.isBlessed() && (activeChar.getAchievementPlayer().getAchievementCount("enchant") < item.getEnchantLevel()))
						{
							activeChar.getAchievementPlayer().setAchievementPoints("enchant", item.getEnchantLevel());
						}
