...
public final class Config extends AbstractConfigs
{
    ...
    public static boolean SP_ITEM_DROP_ENABLE;
    public static int SP_ITEM_ID;
    public static double SP_ITEM_DROP_PERCENT_FROM_SP;
    public static double SP_ITEM_DROP_BONUS_FOR_PREMIUM;
    ...
    public static double L2JMOD_CHAMPION_HP;
    ...
    public static float L2JMOD_CHAMPION_CASTING_SPD_ATK;
    public static float L2JMOD_CHAMPION_PHYSICAL_SPD_ATK;
    public static float L2JMOD_CHAMPION_MDEF;
    public static float L2JMOD_CHAMPION_PDEF;
    public static float L2JMOD_CHAMPION_SPEED_BONUS;
    ...
    public static double L2JMOD_CHAMPION_MEN_BONUS;
    public static double L2JMOD_CHAMPION_DEX_BONUS;
    public static double L2JMOD_CHAMPION_INT_BONUS;
    public static double L2JMOD_CHAMPION_STR_BONUS;
    public static double L2JMOD_CHAMPION_CON_BONUS;
    public static double L2JMOD_CHAMPION_WIT_BONUS;
    ...
    // Gift Codes by Erlandys
    public static HashMap<Integer, Boolean> GIFT_CODES_TYPES = new HashMap<>();
    public static HashMap<Integer, ArrayList<int[]>> GIFT_CODES_REWARDS = new HashMap<>();

    // PC Bang settings by Erlandys
    ...
    public static double PCB_BONUS_FOR_PREMIUM;

    // Premium Weeks Config + Additional Configs
    public static int PREMIUM_ITEM_AMOUNT_WEEK_1;
    public static int PREMIUM_ITEM_ID_WEEK_1;
    public static int PREMIUM_ITEM_AMOUNT_MONTH_1;
    public static int PREMIUM_ITEM_ID_MONTH_1;
    ...
    public static double MONSTER_ATK_SPD_MULTIPLIER;
    public static double MONSTER_CAST_SPD_MULTIPLIER;
    public static double MONSTER_SPEED_MULTIPLIER;
    public static double MONSTER_MEN_MULTIPLIER;
    public static double MONSTER_DEX_MULTIPLIER;
    public static double MONSTER_INT_MULTIPLIER;
    public static double MONSTER_STR_MULTIPLIER;
    public static double MONSTER_CON_MULTIPLIER;
    public static double MONSTER_WIT_MULTIPLIER;
    // Global Raid's Bonuses
    public static double RAID_HP_MULTIPLIER;
    public static double RAID_PATK_MULTIPLIER;
    public static double RAID_MATK_MULTIPLIER;
    public static double RAID_PDEF_MULTIPLIER;
    public static double RAID_MDEF_MULTIPLIER;
    public static double RAID_ATK_SPD_MULTIPLIER;
    public static double RAID_CAST_SPD_MULTIPLIER;
    public static double RAID_SPEED_MULTIPLIER;
    public static double RAID_MEN_MULTIPLIER;
    public static double RAID_DEX_MULTIPLIER;
    public static double RAID_INT_MULTIPLIER;
    public static double RAID_STR_MULTIPLIER;
    public static double RAID_CON_MULTIPLIER;
    public static double RAID_WIT_MULTIPLIER;
    public static double GRAND_HP_MULTIPLIER;
    public static double GRAND_PATK_MULTIPLIER;
    public static double GRAND_MATK_MULTIPLIER;
    public static double GRAND_PDEF_MULTIPLIER;
    public static double GRAND_MDEF_MULTIPLIER;
    public static double GRAND_ATK_SPD_MULTIPLIER;
    public static double GRAND_CAST_SPD_MULTIPLIER;
    public static double GRAND_SPEED_MULTIPLIER;
    public static double GRAND_MEN_MULTIPLIER;
    public static double GRAND_DEX_MULTIPLIER;
    public static double GRAND_INT_MULTIPLIER;
    public static double GRAND_STR_MULTIPLIER;
    public static double GRAND_CON_MULTIPLIER;
    public static double GRAND_WIT_MULTIPLIER;
    ...
    public static double DEFENDER_ATK_SPD_MULTIPLIER;
    public static double DEFENDER_CAST_SPD_MULTIPLIER;
    public static double DEFENDER_SPEED_MULTIPLIER;
    public static double DEFENDER_MEN_MULTIPLIER;
    public static double DEFENDER_DEX_MULTIPLIER;
    public static double DEFENDER_INT_MULTIPLIER;
    public static double DEFENDER_STR_MULTIPLIER;
    public static double DEFENDER_CON_MULTIPLIER;
    public static double DEFENDER_WIT_MULTIPLIER;
    public static double MINION_HP_MULTIPLIER;
    public static double MINION_PATK_MULTIPLIER;
    public static double MINION_MATK_MULTIPLIER;
    public static double MINION_PDEF_MULTIPLIER;
    public static double MINION_MDEF_MULTIPLIER;
    public static double MINION_ATK_SPD_MULTIPLIER;
    public static double MINION_CAST_SPD_MULTIPLIER;
    public static double MINION_SPEED_MULTIPLIER;
    public static double MINION_MEN_MULTIPLIER;
    public static double MINION_DEX_MULTIPLIER;
    public static double MINION_INT_MULTIPLIER;
    public static double MINION_STR_MULTIPLIER;
    public static double MINION_CON_MULTIPLIER;
    public static double MINION_WIT_MULTIPLIER;
    // Monsters' Level Dependent Bonuses
    public static HashMap<Integer, Double> MONSTER_LEVEL_DEPENDENT_HP_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_LEVEL_DEPENDENT_P_ATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_LEVEL_DEPENDENT_M_ATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_LEVEL_DEPENDENT_P_DEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_LEVEL_DEPENDENT_M_DEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_LEVEL_DEPENDENT_ATK_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_LEVEL_DEPENDENT_CST_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_LEVEL_DEPENDENT_SPD_MULTIPLIER = new HashMap<>();
    // Other Bonuses
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_HP_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_PATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_MATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_PDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_MDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_ATK_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_CAST_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_SPEED_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_MEN_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_DEX_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_INT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_STR_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_CON_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MONSTER_INDIVIDUAL_WIT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_HP_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_PATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_MATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_PDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_MDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_ATK_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_CAST_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_SPEED_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_MEN_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_DEX_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_INT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_STR_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_CON_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> RAID_INDIVIDUAL_WIT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_HP_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_PATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_MATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_PDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_MDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_ATK_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_CAST_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_SPEED_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_MEN_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_DEX_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_INT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_STR_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_CON_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> GRAND_INDIVIDUAL_WIT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_HP_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_PATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_MATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_PDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_MDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_ATK_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_CAST_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_SPEED_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_MEN_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_DEX_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_INT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_STR_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_CON_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> DEFENDER_INDIVIDUAL_WIT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_HP_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_PATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_MATK_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_PDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_MDEF_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_ATK_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_CAST_SPD_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_SPEED_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_MEN_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_DEX_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_INT_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_STR_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_CON_MULTIPLIER = new HashMap<>();
    public static HashMap<Integer, Double> MINION_INDIVIDUAL_WIT_MULTIPLIER = new HashMap<>();
    ...
    public static void load()
    {
        if (Server.serverMode == Server.MODE_GAMESERVER)
        {
            ...
            // Premium Weeks Config + Additional Configs
            PREMIUM_ITEM_ID_WEEK_1 = Character.getInt("ItemIDForWeek1", 40906);
            PREMIUM_ITEM_AMOUNT_WEEK_1 = Character.getInt("ItemAmountforPremiumWeeks1", 1);
            PREMIUM_ITEM_ID_MONTH_1 = Character.getInt("ItemIDForPremium1", 40907);
            PREMIUM_ITEM_AMOUNT_MONTH_1 = Character.getInt("ItemAmountforPremiumMonth1", 1);
            ...
            // Global Monster's Bonuses Defaults
            MONSTER_HP_MULTIPLIER = NPC.getDouble("MonsterHPMultiplier", 1.0);
            MONSTER_PATK_MULTIPLIER = NPC.getDouble("MonsterPAtkMultiplier", 1.0);
            MONSTER_MATK_MULTIPLIER = NPC.getDouble("MonsterMAtkMultiplier", 1.0);
            MONSTER_PDEF_MULTIPLIER = NPC.getDouble("MonsterPDefMultiplier", 1.0);
            MONSTER_MDEF_MULTIPLIER = NPC.getDouble("MonsterMDefMultiplier", 1.0);
            MONSTER_ATK_SPD_MULTIPLIER = NPC.getDouble("MonsterAtkSpdMultiplier", 1.0);
            MONSTER_CAST_SPD_MULTIPLIER = NPC.getDouble("MonsterCastSpdMultiplier", 1.0);
            MONSTER_SPEED_MULTIPLIER = NPC.getDouble("MonsterSpeedMultiplier", 1.0);
            // Other Bonuses
            MONSTER_MEN_MULTIPLIER = NPC.getDouble("MonsterMENMultiplier", 1.0);
            MONSTER_DEX_MULTIPLIER = NPC.getDouble("MonsterDEXMultiplier", 1.0);
            MONSTER_INT_MULTIPLIER = NPC.getDouble("MonsterINTMultiplier", 1.0);
            MONSTER_STR_MULTIPLIER = NPC.getDouble("MonsterSTRMultiplier", 1.0);
            MONSTER_CON_MULTIPLIER = NPC.getDouble("MonsterCONMultiplier", 1.0);
            MONSTER_WIT_MULTIPLIER = NPC.getDouble("MonsterWITMultiplier", 1.0);
            RAID_HP_MULTIPLIER = NPC.getDouble("RaidHPMultiplier", 1.0);
            RAID_PATK_MULTIPLIER = NPC.getDouble("RaidPAtkMultiplier", 1.0);
            RAID_MATK_MULTIPLIER = NPC.getDouble("RaidMAtkMultiplier", 1.0);
            RAID_PDEF_MULTIPLIER = NPC.getDouble("RaidPDefMultiplier", 1.0);
            RAID_MDEF_MULTIPLIER = NPC.getDouble("RaidMDefMultiplier", 1.0);
            RAID_ATK_SPD_MULTIPLIER = NPC.getDouble("RaidAtkSpdMultiplier", 1.0);
            RAID_CAST_SPD_MULTIPLIER = NPC.getDouble("RaidCastSpdMultiplier", 1.0);
            RAID_SPEED_MULTIPLIER = NPC.getDouble("RaidSpeedMultiplier", 1.0);
            RAID_MEN_MULTIPLIER = NPC.getDouble("RaidMENMultiplier", 1.0);
            RAID_DEX_MULTIPLIER = NPC.getDouble("RaidDEXMultiplier", 1.0);
            RAID_INT_MULTIPLIER = NPC.getDouble("RaidINTMultiplier", 1.0);
            RAID_STR_MULTIPLIER = NPC.getDouble("RaidSTRMultiplier", 1.0);
            RAID_CON_MULTIPLIER = NPC.getDouble("RaidCONMultiplier", 1.0);
            RAID_WIT_MULTIPLIER = NPC.getDouble("RaidWITMultiplier", 1.0);
            GRAND_HP_MULTIPLIER = NPC.getDouble("GrandHPMultiplier", 1.0);
            GRAND_PATK_MULTIPLIER = NPC.getDouble("GrandPAtkMultiplier", 1.0);
            GRAND_MATK_MULTIPLIER = NPC.getDouble("GrandMAtkMultiplier", 1.0);
            GRAND_PDEF_MULTIPLIER = NPC.getDouble("GrandPDefMultiplier", 1.0);
            GRAND_MDEF_MULTIPLIER = NPC.getDouble("GrandMDefMultiplier", 1.0);
            GRAND_ATK_SPD_MULTIPLIER = NPC.getDouble("GrandAtkSpdMultiplier", 1.0);
            GRAND_CAST_SPD_MULTIPLIER = NPC.getDouble("GrandCastSpdMultiplier", 1.0);
            GRAND_SPEED_MULTIPLIER = NPC.getDouble("GrandSpeedMultiplier", 1.0);
            GRAND_MEN_MULTIPLIER = NPC.getDouble("GrandMENMultiplier", 1.0);
            GRAND_DEX_MULTIPLIER = NPC.getDouble("GrandDEXMultiplier", 1.0);
            GRAND_INT_MULTIPLIER = NPC.getDouble("GrandINTMultiplier", 1.0);
            GRAND_STR_MULTIPLIER = NPC.getDouble("GrandSTRMultiplier", 1.0);
            GRAND_CON_MULTIPLIER = NPC.getDouble("GrandCONMultiplier", 1.0);
            GRAND_WIT_MULTIPLIER = NPC.getDouble("GrandWITMultiplier", 1.0);
            DEFENDER_HP_MULTIPLIER = NPC.getDouble("DefenderHPMultiplier", 1.0);
            DEFENDER_PATK_MULTIPLIER = NPC.getDouble("DefenderPAtkMultiplier", 1.0);
            DEFENDER_MATK_MULTIPLIER = NPC.getDouble("DefenderMAtkMultiplier", 1.0);
            DEFENDER_PDEF_MULTIPLIER = NPC.getDouble("DefenderPDefMultiplier", 1.0);
            DEFENDER_MDEF_MULTIPLIER = NPC.getDouble("DefenderMDefMultiplier", 1.0);
            DEFENDER_ATK_SPD_MULTIPLIER = NPC.getDouble("DefenderAtkSpdMultiplier", 1.0);
            DEFENDER_CAST_SPD_MULTIPLIER = NPC.getDouble("DefenderCastSpdMultiplier", 1.0);
            DEFENDER_SPEED_MULTIPLIER = NPC.getDouble("DefenderSpeedMultiplier", 1.0);
            DEFENDER_MEN_MULTIPLIER = NPC.getDouble("DefenderMENMultiplier", 1.0);
            DEFENDER_DEX_MULTIPLIER = NPC.getDouble("DefenderDEXMultiplier", 1.0);
            DEFENDER_INT_MULTIPLIER = NPC.getDouble("DefenderINTMultiplier", 1.0);
            DEFENDER_STR_MULTIPLIER = NPC.getDouble("DefenderSTRMultiplier", 1.0);
            DEFENDER_CON_MULTIPLIER = NPC.getDouble("DefenderCONMultiplier", 1.0);
            DEFENDER_WIT_MULTIPLIER = NPC.getDouble("DefenderWITMultiplier", 1.0);
            MINION_HP_MULTIPLIER = NPC.getDouble("MinionHPMultiplier", 1.0);
            MINION_PATK_MULTIPLIER = NPC.getDouble("MinionPAtkMultiplier", 1.0);
            MINION_MATK_MULTIPLIER = NPC.getDouble("MinionMAtkMultiplier", 1.0);
            MINION_PDEF_MULTIPLIER = NPC.getDouble("MinionPDefMultiplier", 1.0);
            MINION_MDEF_MULTIPLIER = NPC.getDouble("MinionMDefMultiplier", 1.0);
            MINION_ATK_SPD_MULTIPLIER = NPC.getDouble("MinionAtkSpdMultiplier", 1.0);
            MINION_CAST_SPD_MULTIPLIER = NPC.getDouble("MinionCastSpdMultiplier", 1.0);
            MINION_SPEED_MULTIPLIER = NPC.getDouble("MinionSpeedMultiplier", 1.0);
            MINION_MEN_MULTIPLIER = NPC.getDouble("MinionMENMultiplier", 1.0);
            MINION_DEX_MULTIPLIER = NPC.getDouble("MinionDEXMultiplier", 1.0);
            MINION_INT_MULTIPLIER = NPC.getDouble("MinionINTMultiplier", 1.0);
            MINION_STR_MULTIPLIER = NPC.getDouble("MinionSTRMultiplier", 1.0);
            MINION_CON_MULTIPLIER = NPC.getDouble("MinionCONMultiplier", 1.0);
            MINION_WIT_MULTIPLIER = NPC.getDouble("MinionWITMultiplier", 1.0);

            MONSTER_LEVEL_DEPENDENT_HP_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterLevelDependentHPMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_LEVEL_DEPENDENT_HP_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_LEVEL_DEPENDENT_P_ATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterLevelDependentPAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_LEVEL_DEPENDENT_P_ATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_LEVEL_DEPENDENT_M_ATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterLevelDependentMAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_LEVEL_DEPENDENT_M_ATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_LEVEL_DEPENDENT_P_DEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterLevelDependentPDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_LEVEL_DEPENDENT_P_DEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_LEVEL_DEPENDENT_M_DEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterLevelDependentMDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_LEVEL_DEPENDENT_M_DEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_LEVEL_DEPENDENT_ATK_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterLevelDependentAtkSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_LEVEL_DEPENDENT_ATK_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_LEVEL_DEPENDENT_CST_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterLevelDependentCstSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_LEVEL_DEPENDENT_CST_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_LEVEL_DEPENDENT_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterLevelDependentSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_LEVEL_DEPENDENT_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            // TEST

            MONSTER_INDIVIDUAL_HP_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualHPMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_HP_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_PATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualPAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_PATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_MATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualMAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_MATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_PDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualPDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_PDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_MDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualMDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_MDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_ATK_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualAtkSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_ATK_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_CAST_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualCastSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_CAST_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_SPEED_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualSpeedMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_SPEED_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_MEN_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualMENMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_MEN_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_DEX_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualDEXMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_DEX_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_STR_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualSTRMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_STR_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_CON_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualCONMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_CON_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_WIT_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualWITMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_WIT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MONSTER_INDIVIDUAL_INT_MULTIPLIER.clear();
            propertySplit = NPC.getString("MonsterIndividualINTMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MONSTER_INDIVIDUAL_INT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_HP_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualHPMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_HP_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_PATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualPAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_PATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_MATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualMAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_MATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_PDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualPDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_PDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_MDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualMDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_MDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_ATK_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualAtkSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_ATK_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_CAST_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualCastSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_CAST_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_SPEED_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualSpeedMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_SPEED_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_MEN_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualMENMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_MEN_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_DEX_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualDEXMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_DEX_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_STR_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualSTRMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_STR_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_CON_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualCONMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_CON_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_WIT_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualWITMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_WIT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            RAID_INDIVIDUAL_INT_MULTIPLIER.clear();
            propertySplit = NPC.getString("RaidIndividualINTMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                RAID_INDIVIDUAL_INT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_HP_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualHPMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_HP_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_PATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualPAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_PATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_MATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualMAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_MATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_PDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualPDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_PDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_MDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualMDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_MDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_ATK_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualAtkSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_ATK_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_CAST_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualCastSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_CAST_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_SPEED_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualSpeedMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_SPEED_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_MEN_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualMENMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_MEN_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_DEX_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualDEXMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_DEX_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_STR_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualSTRMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_STR_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_CON_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualCONMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_CON_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_WIT_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualWITMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_WIT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            GRAND_INDIVIDUAL_INT_MULTIPLIER.clear();
            propertySplit = NPC.getString("GrandIndividualINTMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                GRAND_INDIVIDUAL_INT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_HP_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualHPMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_HP_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_PATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualPAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_PATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_MATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualMAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_MATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_PDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualPDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_PDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_MDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualMDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_MDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_ATK_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualAtkSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_ATK_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_CAST_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualCastSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_CAST_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_SPEED_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualSpeedMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_SPEED_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_MEN_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualMENMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_MEN_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_DEX_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualDEXMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_DEX_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_STR_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualSTRMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_STR_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_CON_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualCONMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_CON_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_WIT_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualWITMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_WIT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            DEFENDER_INDIVIDUAL_INT_MULTIPLIER.clear();
            propertySplit = NPC.getString("DefenderIndividualINTMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                DEFENDER_INDIVIDUAL_INT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_HP_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualHPMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_HP_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_PATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualPAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_PATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_MATK_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualMAtkMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_MATK_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_PDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualPDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_PDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_MDEF_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualMDefMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_MDEF_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_ATK_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualAtkSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_ATK_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_CAST_SPD_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualCastSpdMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_CAST_SPD_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_SPEED_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualSpeedMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_SPEED_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_MEN_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualMENMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_MEN_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_DEX_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualDEXMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_DEX_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_STR_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualSTRMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_STR_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_CON_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualCONMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_CON_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_WIT_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualWITMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_WIT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }

            MINION_INDIVIDUAL_INT_MULTIPLIER.clear();
            propertySplit = NPC.getString("MinionIndividualINTMultiplier", "").split(";");
            for (String prop : propertySplit)
            {
                String[] propSplit = prop.split(",");
                MINION_INDIVIDUAL_INT_MULTIPLIER.put(Integer.valueOf(propSplit[0]), Double.valueOf(propSplit[1]));
            }
            ...
            L2JMOD_CHAMPION_HP = champions.getDouble("ChampionHp", 4.0);
            ...
            L2JMOD_CHAMPION_MATK = champions.getFloat("ChampionMAtk", 1);
            L2JMOD_CHAMPION_PATK = champions.getFloat("ChampionPAtk", 1);
            L2JMOD_CHAMPION_CASTING_SPD_ATK = champions.getFloat("ChampionCastingSpdAtk", 1);
            L2JMOD_CHAMPION_PHYSICAL_SPD_ATK = champions.getFloat("ChampionPhysicalSpdAtk", 1);
            L2JMOD_CHAMPION_MDEF = champions.getFloat("ChampionMdef", 1);
            L2JMOD_CHAMPION_PDEF = champions.getFloat("ChampionPdef", 1);
            L2JMOD_CHAMPION_SPEED_BONUS = champions.getFloat("ChampionSpeed", 1);
            ...
            L2JMOD_CHAMPION_MEN_BONUS = champions.getInt("ChampionMENbonus", 1);
            L2JMOD_CHAMPION_DEX_BONUS = champions.getInt("ChampionDEXbonus", 1);
            L2JMOD_CHAMPION_INT_BONUS = champions.getInt("ChampionINTbonus", 1);
            L2JMOD_CHAMPION_STR_BONUS = champions.getInt("ChampionSTRbonus", 1);
            L2JMOD_CHAMPION_CON_BONUS = champions.getInt("ChampionCONbonus", 1);
            L2JMOD_CHAMPION_WIT_BONUS = champions.getInt("ChampionWITbonus", 1);
            ...
            // Gift Codes by Erlandys
            String codeRewards[] = L2JModSettings.getString("GiftCodeRewards", "").split(";");
            GIFT_CODES_REWARDS.clear();
            for (String r : codeRewards)
            {
                int charsCount = Integer.parseInt(r.split("=")[0]);
                ArrayList<int[]> its = new ArrayList<>();
                for (String reward : r.split("=")[1].split("/"))
                {
                    int itemId = Integer.parseInt(reward.split(",")[0]);
                    int minCount = Integer.parseInt(reward.split(",")[1].split("_")[0]);
                    int maxCount = Integer.parseInt(reward.split(",")[1].split("_")[1]);
                    its.add(new int[]
                            {
                                    itemId,
                                    minCount,
                ...
                GIFT_CODES_REWARDS.put(charsCount, its);
            }
            String codeTypes[] = L2JModSettings.getString("GiftCodeTypes", "").split(";");
            GIFT_CODES_TYPES.clear();
            for (String r : codeTypes)
            {
                GIFT_CODES_TYPES.put(Integer.parseInt(r.split(",")[0]), r.split(",")[1].equalsIgnoreCase("true"));
            }
            // PC Bang Points by Erlandys
            PCB_ENABLE = L2JModSettings.getBoolean("PcBangPointEnable", true);
            PCB_MIN_LEVEL = L2JModSettings.getInt("PcBangPointMinLevel", 20);
            PCB_POINT_MIN = L2JModSettings.getInt("PcBangPointMinCount", 20);
            PCB_POINT_MAX = L2JModSettings.getInt("PcBangPointMaxCount", 1000000);
            if (PCB_POINT_MAX < 1)
            {
                PCB_POINT_MAX = Integer.MAX_VALUE;
            }
            PCB_CHANCE_DUAL_POINT = L2JModSettings.getInt("PcBangPointDualChance", 20);
            PCB_INTERVAL = L2JModSettings.getInt("PcBangPointTimeStamp", 900);
            PCB_BONUS_FOR_PREMIUM = L2JModSettings.getDouble("PcBangPointBonusForPremium", 1.0);
            ...
            REMOVE_FROM_DROP = dropsload.getString("ListRemoveFromDrop", "1341,1342,1343,1344,1345,1047,1048,1049,1050,1051");
            ...
            SP_ITEM_DROP_ENABLE = dropsload.getBoolean("SpItemDropEnabled", true);
            SP_ITEM_ID = dropsload.getInt("SpItemDropID", 57);
            SP_ITEM_DROP_PERCENT_FROM_SP = dropsload.getDouble("SpItemDropPercentFromSP", 0.15);
            SP_ITEM_DROP_BONUS_FOR_PREMIUM = dropsload.getDouble("SpItemDropBonusForPremium", 1.15);
